...
corrs = matchFeatures(descriptors',feature_collection.descriptors', 'MatchThreshold', 100, 'MaxRatio', 0.6);


summa = feature_collection.labels(corrs(:,2));      % Extract labels of matching feature points
vote = zeros(1,5); 
